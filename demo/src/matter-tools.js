...
var _initDatGui = function(gui) {
  ...
  if (engine) {
    ...
    gravity.add(engine.world.gravity, 'scale', 0, 0.005).step(0.0001);
          ...
          <div class="matter-header-inner">
            ...
            <div class="matter-toolbar">
              ...
              <button class="matter-btn matter-btn-fullscreen" title="Fullscreen">
                ...
                <svg class="spin" height="30" version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" 
                viewBox="0 0 83.631 83.631" xml:space="preserve">
                <g>
                    <g>
                        <g>
...
@keyframes spin {
  ...
  /* Apply the spin animation with infinite loops and a defined speed */
  .spin {
    animation: spin 2s linear infinite; /* 4 seconds for one full rotation */
  }
...
.matter-demo {
  ...
  .matter-select-wrapper:after {
    ...
    width: 28px;
    height: 100%;
    background: linear-gradient(-90deg, rgb(14, 15, 25, 0), rgb(14, 15, 25, 0));
    right: 23px;
    top: 0;
  }
